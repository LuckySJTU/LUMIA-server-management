...
class SlurmwebAppGateway(SlurmwebWebApp, RFLTokenizedWebApp):
    ...
    VIEWS = {
        ...
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/overview", views.gpu_monitor_overview),
        SlurmwebAppRoute(
            "/api/agents/<cluster>/gpu-monitor/overview/history",
            views.gpu_monitor_overview_history,
        ),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/jobs", views.gpu_monitor_jobs),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/job/<int:job>", views.gpu_monitor_job),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/nodes", views.gpu_monitor_nodes),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/node/<name>", views.gpu_monitor_node),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/users", views.gpu_monitor_users),
        SlurmwebAppRoute("/api/agents/<cluster>/gpu-monitor/alerts", views.gpu_monitor_alerts),
        ...
        SlurmwebAppRoute(
            "/api/agents/<cluster>/cancel-all/<int:job>",
            views.cancel_all,
            methods=["DELETE"],
        ),
    }
